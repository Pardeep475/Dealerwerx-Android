...
public class BoatScavengerListingsAdapter extends ScavengerListingsAdapter{
    public BoatScavengerListingsAdapter(Context context, int resource, List<Listing> items) {
