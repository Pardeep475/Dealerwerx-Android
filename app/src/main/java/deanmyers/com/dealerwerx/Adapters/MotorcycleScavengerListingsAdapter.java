...
public class MotorcycleScavengerListingsAdapter extends ScavengerListingsAdapter{
    public MotorcycleScavengerListingsAdapter(Context context, int resource, List<Listing> items) {
