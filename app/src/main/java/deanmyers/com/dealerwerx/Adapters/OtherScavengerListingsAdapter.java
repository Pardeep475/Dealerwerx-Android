...
public class OtherScavengerListingsAdapter extends ScavengerListingsAdapter{
    public OtherScavengerListingsAdapter(Context context, int resource, List<Listing> items) {
