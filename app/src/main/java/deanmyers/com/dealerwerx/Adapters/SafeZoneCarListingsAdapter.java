...
public class SafeZoneCarListingsAdapter extends SafeZoneListingsAdapter{
    public SafeZoneCarListingsAdapter(Context context, int resource, List<Listing> items) {
