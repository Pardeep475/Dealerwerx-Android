...
public class SafeZoneBoatListingsAdapter extends SafeZoneListingsAdapter{
    public SafeZoneBoatListingsAdapter(Context context, int resource, List<Listing> items) {
