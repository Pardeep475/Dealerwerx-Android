...
import deanmyers.project.dealerwerx.API.APIConsumer.LoginAsyncTask;
...
public class LoginActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView skipViewListener = (TextView)findViewById(R.id.skip);
        skipViewListener.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("LOGIN_CLICK","SKIP CLICK LISTENER");
                goToListings();
            }
        });
