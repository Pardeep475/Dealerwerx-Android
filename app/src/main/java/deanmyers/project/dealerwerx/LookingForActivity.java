    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (PreferencesManager.getUserInformation() == null) {
                    ...
                    Intent loginIntent = new Intent(LookingForActivity.this, LoginActivity.class);
        ...
        srlListener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                APIConsumer.GetLookingForListingsAsyncTask task = APIConsumer.GetLookingForListings(accessToken, new APIResponder<Listing[]>() {
                    @Override
